...
class Space : Node {
  ...
  public string GetDescription()
  {
    ...
    if(location == "LandsbyAziz"){
      description = "Du har valgt at returnere tilbage til landsbyen. Tilbage ved husene møder du Aziz og Kofi, de hjælper dig med at reparere husene. Efterfølgende kommer du i snak med Aziz, som fortæller stolt at han er sygeplejerske hos det lokale hospital. Aziz fortæller sørgmodigt, at hospitalet har stærkt behov for ressourcer. \n Ignore Aziz anmodning for hjælp eller hjælpe Jørgen med at skaffe ressourcer til hospitalet."; }

    if(location == "Hospital"){
      description = "Som borgermester, kontakter du andre nærlæggende byer og anstandser for at købe og forhandle om ressourcer til hospitalet. Efter hårde, men successfulde forhandlinger vender du tilbage til hospitalet med medicin og diverse ting. \n Tag medicin og ressourcer, og sælg det videre eller giv Aziz og hospitalet ressourcerne.
            }
  }
}
}

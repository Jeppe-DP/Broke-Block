...
public class Quiz
{
    ...
    public void Start () //køre quizzen
{
    Console.Clear();
    ...
    foreach (Question q in questions)
    {
        ...
        //for-loop gennemgår hvert eneklt svar i listen og viser dem på skærmen
        ...
        Console.WriteLine("Dit svar (1-4);");
